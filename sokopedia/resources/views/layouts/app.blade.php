        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <p style="color:rgb(3, 172, 14);margin:0;">{{ config('app.name', '$okopedia') }}</p>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    @section('search')
                        <form method="GET" action="{{ route('search') }}">
                            <div class="d-flex">
                                <input id="search" name="search" type="text" placeholder="Search by Name" class="form-control" autocomplete="search">
